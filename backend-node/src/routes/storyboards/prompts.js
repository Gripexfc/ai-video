...
/**
 * Prompts sub-router: framePrompt, framePromptsGet, polishPrompt,
 * polishUniversalSegmentStream, polishClassicVideoPromptStream,
 * generateUniversalSegmentStream, generateUniversalSegmentPrompt
 */
function setupPromptsSubRouter(db, log) {
  return {
    framePrompt: (req, res) => {
      try {
        const body = req.body || {};
...
module.exports = { setupPromptsSubRouter };
