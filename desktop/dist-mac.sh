...
echo "========== 全部构建完成 =========="
echo "输出目录：release/"
echo "  完整版（Intel）：视频miao~-x.x.x-mac-x64.dmg"
echo "  完整版（ARM）  ：视频miao~-x.x.x-mac-arm64.dmg"
echo "  纯净版（Intel）：视频miao~-Lite-x.x.x-mac-x64.dmg"
echo "  纯净版（ARM）  ：视频miao~-Lite-x.x.x-mac-arm64.dmg"
echo ""
